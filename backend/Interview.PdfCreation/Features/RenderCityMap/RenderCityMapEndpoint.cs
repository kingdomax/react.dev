...
{
    public static async Task<FileContentHttpResult> GetPdfFile(string name, IBrowserWrapper browserWrapper)
    {
    ...
    public static async Task<IResult> GetZipFile(string name, IBrowserWrapper browserWrapper)
    {
